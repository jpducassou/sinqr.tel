...
package Amazon::SimpleDB::Model::DeleteDomainResponse;
...
use base qw (Amazon::SimpleDB::Model);
    ...
    #
    # Amazon::SimpleDB::Model::DeleteDomainResponse
    # 
    # Properties:
    #
    # 
    ...
    sub new {
     ...
     #
     # Construct Amazon::SimpleDB::Model::DeleteDomainResponse from XML string
     # 
    sub fromXML {
        my ($self, $xml) = @_;
        eval "use XML::Simple";
        ...
        return new Amazon::SimpleDB::Model::DeleteDomainResponse($tree);
