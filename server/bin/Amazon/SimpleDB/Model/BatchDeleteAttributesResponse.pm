...
package Amazon::SimpleDB::Model::BatchDeleteAttributesResponse;
...
use base qw (Amazon::SimpleDB::Model);
    ...
    #
    # Amazon::SimpleDB::Model::BatchDeleteAttributesResponse
    # 
    # Properties:
    #
    # 
    ...
    sub new {
     ...
     #
     # Construct Amazon::SimpleDB::Model::BatchDeleteAttributesResponse from XML string
     # 
    sub fromXML {
        my ($self, $xml) = @_;
        eval "use XML::Simple";
        ...
        return new Amazon::SimpleDB::Model::BatchDeleteAttributesResponse($tree);
    ...
    sub toXML {
        my $self = shift;
        my $xml = "";
        $xml .= "<BatchDeleteAttributesResponse xmlns=\"http://sdb.amazonaws.com/doc/2009-04-15/\">";
        $xml .= $self->_toXMLFragment();
        $xml .= "</BatchDeleteAttributesResponse>";
        return $xml;
    }
