...
package Amazon::SimpleDB::Model::DeleteAttributesResponse;
...
use base qw (Amazon::SimpleDB::Model);
    ...
    #
    # Amazon::SimpleDB::Model::DeleteAttributesResponse
    # 
    # Properties:
    #
    # 
    ...
    sub new {
     ...
     #
     # Construct Amazon::SimpleDB::Model::DeleteAttributesResponse from XML string
     # 
    sub fromXML {
        my ($self, $xml) = @_;
        eval "use XML::Simple";
        ...
        return new Amazon::SimpleDB::Model::DeleteAttributesResponse($tree);
