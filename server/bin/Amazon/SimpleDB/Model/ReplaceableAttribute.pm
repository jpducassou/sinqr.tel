...
package Amazon::SimpleDB::Model::ReplaceableAttribute;
...
use base qw (Amazon::SimpleDB::Model);
    ...
    #
    # Amazon::SimpleDB::Model::ReplaceableAttribute
    # 
    # Properties:
    #
    # 
    ...
    sub new {
        ...
        $self->{_fields} = {
            ...
            Replace => { FieldValue => undef, FieldType => "bool"},
        };
    ...
    sub getReplace {
        return shift->{_fields}->{Replace}->{FieldValue};
    }
    ...
    sub setReplace {
        ...
        $self->{_fields}->{Replace}->{FieldValue} = $value;
        return $self;
    }
    ...
    sub withReplace {
        my ($self, $value) = @_;
        $self->setReplace($value);
        return $self;
    }


    sub isSetReplace {
        return defined (shift->{_fields}->{Replace}->{FieldValue});
    }
