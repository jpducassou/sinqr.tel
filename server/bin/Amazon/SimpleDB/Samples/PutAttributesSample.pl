...
use lib qw(../../../.);  
 ...
 # @TODO: set request. Action can be passed as Amazon::SimpleDB::Model::PutAttributesRequest
 ...
 # invokePutAttributes($service, $request);
    ...
    #
  sub invokePutAttributes {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->putAttributes($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        PutAttributesResponse\n");
