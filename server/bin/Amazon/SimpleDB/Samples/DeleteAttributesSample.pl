...
use lib qw(../../../.);  
 ...
 # @TODO: set request. Action can be passed as Amazon::SimpleDB::Model::DeleteAttributesRequest
 ...
 # invokeDeleteAttributes($service, $request);
    ...
    #
  sub invokeDeleteAttributes {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deleteAttributes($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeleteAttributesResponse\n");
