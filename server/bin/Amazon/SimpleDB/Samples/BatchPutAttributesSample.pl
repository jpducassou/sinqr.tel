...
use lib qw(../../../.);  
 ...
 # @TODO: set request. Action can be passed as Amazon::SimpleDB::Model::BatchPutAttributesRequest
 ...
 # invokeBatchPutAttributes($service, $request);
    ...
    #
  sub invokeBatchPutAttributes {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->batchPutAttributes($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        BatchPutAttributesResponse\n");
