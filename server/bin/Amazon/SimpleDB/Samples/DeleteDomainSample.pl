...
use lib qw(../../../.);  
 ...
 # @TODO: set request. Action can be passed as Amazon::SimpleDB::Model::DeleteDomainRequest
 ...
 # invokeDeleteDomain($service, $request);
    ...
    #
  sub invokeDeleteDomain {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deleteDomain($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeleteDomainResponse\n");
